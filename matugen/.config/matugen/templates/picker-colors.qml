...
Scope {
    ...
    property color mdSurface: "{{colors.surface.default.hex}}"
    property color mdOnSurface: "{{colors.on_surface.default.hex}}"
    property color mdPrimary: "{{colors.primary.default.hex}}"
    property color mdOnPrimary: "{{colors.on_primary.default.hex}}"
    property color mdSecondary: "{{colors.secondary.default.hex}}"
    property color mdOnSecondary: "{{colors.on_secondary.default.hex}}"
    property color mdTertiary: "{{colors.tertiary.default.hex}}"
    property color mdOnTertiary: "{{colors.on_tertiary.default.hex}}"
    property color mdError: "{{colors.error.default.hex}}"
    property color mdOnError: "{{colors.on_error.default.hex}}"
    property color mdOutline: "{{colors.outline.default.hex}}"
    property color mdSurfaceVariant: "{{colors.surface_variant.default.hex}}"
